...
<html class="loading">
  <head>
    ...
    <title>Script Checker - Enhanced</title>
	...
	<div class="row">
        ...
        <div class="card">
				<div class="card-body text-center">
					<h4 class="mb-2"><strong>SCRIPT CHECKER</strong></h4>
...
\
<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:black" value="gate/$5.95.php">STRIPE+WOO $5.95</option>							  
<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:black" value="gate/Auth.php">AUTH1</option>
<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:black" value="gate/Auth1.php">AUTH2</option>
<option style="background:rgba(16, 15, 154, 0.281);color:rgb(255, 208, 0);color:black" value="gate/b3.php">B3+WOO</option>
...
<footer>
  <p>Join for more Updates <a href="https://t.me/+14iMGyZbM2RhYzk1">Click Here!</a></p>
</footer>
<script>
...
swalWithBootstrapButtons.fire({
  title: "WELCOME TO Script CHECKER", 
...
function RedirectUrl(){    
       window.location.href ="https://t.me/+14iMGyZbM2RhYzk1";
    }
...
if(total > 10000){
  Swal.fire({title: 'YOU CAN NOT PERFORM THAT ACTION: REDUCE NUMBER OF CARDS TO < 10000', icon: 'warning', showConfirmButton: false, toast: true, position: 'top-end', timer: 3000});
  return false;
}
