...
//Cart
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://shop.zircon-ssd.com/product/zircon-z1-internal-solid-state-drive-128gb-black-z1-128gb/');
curl_setopt($ch, CURLOPT_USERAGENT, $_SERVER['HTTP_USER_AGENT']);
curl_setopt($ch, CURLOPT_POST, 1);
$headers = array();
$headers[] = 'Host: shop.zircon-ssd.com';
$headers[] = 'Path: /product/zircon-z1-internal-solid-state-drive-128gb-black-z1-128gb/';
$headers[] = 'content-type: multipart/form-data; boundary=----WebKitFormBoundarykCqlrBX40pIh3WnV';
$headers[] = 'accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7';
$headers[] = 'origin: https://shop.zircon-ssd.com';
$headers[] = 'referer: https://shop.zircon-ssd.com/product/zircon-z1-internal-solid-state-drive-128gb-black-z1-128gb/';
$headers[] = 'user-agent: '.$ua.'';
curl_setopt_array($ch, [CURLOPT_COOKIEFILE => $cx, CURLOPT_COOKIEJAR => $cx]);
...
curl_setopt($ch, CURLOPT_POSTFIELDS, '------WebKitFormBoundarykCqlrBX40pIh3WnV
Content-Disposition: form-data; name="quantity"

1
------WebKitFormBoundarykCqlrBX40pIh3WnV
...
//checkout
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://shop.zircon-ssd.com/checkout-2/');
curl_setopt($ch, CURLOPT_USERAGENT, $_SERVER['HTTP_USER_AGENT']);
curl_setopt($ch, CURLOPT_POST, 1);
$headers = array();
$headers[] = 'Host: shop.zircon-ssd.com';
